...
*   **Auto-Swing**: Periodically triggers a right-click (use) action and plays a visual hand swing animation. Perfect for interacting with blocks like levers and buttons automatically.
